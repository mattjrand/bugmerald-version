...
extern const u8 BattleScript_ShowdownModeActivates[];
extern const u8 BattleScript_ShockThreadsActivates[];
...
extern const u8 BattleScript_ShortFuseActivates[];
...
extern const u8 BattleScript_EffectDefendOrder[];
