...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_EARLY_BIRD, ABILITY_RATTLED },
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_VICTORY_STAR, ABILITY_MOTOR_DRIVE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_GOOEY, ABILITY_SNIPER, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .baseSpeed     = 40,
        .baseSpAttack  = 55,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 73 : 60,
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON),
        .catchRate = 90,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 140,
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_GOOEY, ABILITY_SNIPER, ABILITY_SHADOW_TAG },
        .bodyColor = BODY_COLOR_RED,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_TINTED_LENS, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_GREEN,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_PINECO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STURDY, ABILITY_VITAL_SPIRIT, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_BATTERY, ABILITY_BOMBS_AWAY, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DUDUNSPARCE_TWO_SEGMENT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_BERSERK, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TOXIC_DEBRIS, ABILITY_SAND_VEIL, ABILITY_IMMUNITY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TOXIC_DEBRIS, ABILITY_SAND_VEIL, ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_SHELL_ARMOR, ABILITY_SUPERSWEET_SYRUP },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_OWN_TEMPO, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_NONE, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_OWN_TEMPO, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_GREEN,
